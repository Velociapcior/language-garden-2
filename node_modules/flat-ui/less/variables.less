...
@language-garden-primary: #674f7f;
@language-garden-primary-dark: #3b2652;
@language-garden-secondary: #674f7f;
...
@brand-primary:         @language-garden-primary;
@brand-secondary:       @language-garden-secondary;
