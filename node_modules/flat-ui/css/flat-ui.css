...
.dropdown-arrow-inverse {
  border-bottom-color: #674f7f !important;
  border-top-color: #674f7f !important;
}
body {
...
.btn-group > .btn + .dropdown-toggle {
  border-left: 2px solid rgba(103, 79, 127, 0.15);
  padding-left: 12px;
  padding-right: 12px;
}
...
.caret {
  ...
  border-bottom-color: #674f7f;
  border-top-color: #674f7f;
  border-style: solid;
...
.navbar .nav > li > ul:before {
  ...
  border-color: transparent transparent #674f7f transparent;
  height: 0;
  position: absolute;
  left: 15px;
  top: 5px;
...
.navbar-inverse .navbar-brand {
  border-bottom: 2px solid #58436c;
  border-right: 2px solid #58436c;
  color: white;
...
.navbar-inverse .nav > li > a {
  font-size: 16px;
  border-bottom: 2px solid #58436c;
  border-left: 2px solid #58436c !important;
  color: white;
...
.navbar .nav li.dropdown.open > .dropdown-toggle .caret {
  border-bottom-color: #90b96b !important;
  border-top-color: #90b96b !important;
}
...
.navbar .nav li.dropdown > .dropdown-toggle:focus .caret {
  border-bottom-color: #90b96b;
  border-top-color: #90b96b;
}
.navbar .nav li.dropdown > .dropdown-toggle .caret {
  border-left-width: 6px;
  border-right-width: 6px;
  border-top-width: 8px;
  border-bottom-color: #886ca4;
  border-top-color: #886ca4;
  margin-left: 10px;
}
...
.navbar.navbar-inverse .navbar-form.focus .input-group-btn .btn {
  background-color: #58436c !important;
}
.navbar .navbar-form {
  margin: 0;
...
.navbar-fixed-bottom .dropdown .dropdown-arrow {
  border-bottom: none;
  border-top: 8px outset #f6f4f7;
  bottom: 100%;
  top: auto;
}
.navbar-fixed-bottom .nav > li > ul:before {
  border-bottom: none;
  border-top: 9px outset #674f7f;
  bottom: 4px;
  top: auto;
}
...
.dropdown-arrow {
  border-style: solid;
  border-width: 0 9px 9px 9px;
  border-color: transparent transparent #f6f4f7 transparent;
  height: 0;
  margin-top: 0;
  opacity: 0;
  position: absolute;
...
.vjs-mute-control div {
  background: #4d3b5f url(../images/video/volume-full.png) no-repeat center 2px;
  background-size: 16px 64px;
  height: 18px;
...
.login-form:before {
  ...
  border-color: transparent #f1eff3 transparent transparent;
  height: 0;
  position: absolute;
  left: -12px;
  top: 35px;
